...
public class GB_HW1 {
    public static void main(String[] args) {
        ...
        valueReplacement2();
        fillDiagonal();
        System.out.println(Arrays.toString(fillIntValueArray(3, 10)));

        int[] arr = {2, 2, 3, 1, 2, 2, 10, 2};
        System.out.println(compareAmounts(arr));
    }

    public static boolean compareAmounts(int[] arr) {
        int sumLeftArray = 0, sumArray = 0;
        ...
        for (int j = 0; j < arr.length; j++) {
            sumLeftArray += arr[j];
            if (sumLeftArray == sumArray - sumLeftArray) break;
        }
        return (sumLeftArray == sumArray - sumLeftArray);
    }

    public static int[] fillIntValueArray(int len, int initialValue) {
        int[] arr = new int[len];
        for (int i = 0; i < arr.length; i++) {
            arr[i] = initialValue;
        }
    ...
    public static void valueReplacement2() {
    ...
    public static void valueReplacement() {
        final int SIZE = 10;
